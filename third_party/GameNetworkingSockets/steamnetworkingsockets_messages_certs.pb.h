...
class CMsgSteamNetworkingIdentityLegacyBinary final :
 ...
 public:
  ...
  inline CMsgSteamNetworkingIdentityLegacyBinary(const CMsgSteamNetworkingIdentityLegacyBinary& from)
      : CMsgSteamNetworkingIdentityLegacyBinary(nullptr, from) {}
...
class CMsgSteamDatagramCertificateSigned final :
 ...
 public:
  ...
  inline CMsgSteamDatagramCertificateSigned(const CMsgSteamDatagramCertificateSigned& from)
      : CMsgSteamDatagramCertificateSigned(nullptr, from) {}
...
class CMsgSteamDatagramCertificate final :
 ...
 public:
  ...
  inline CMsgSteamDatagramCertificate(const CMsgSteamDatagramCertificate& from)
      : CMsgSteamDatagramCertificate(nullptr, from) {}
...
class CMsgSteamDatagramCertificateRequest final :
 ...
 public:
  ...
  inline CMsgSteamDatagramCertificateRequest(const CMsgSteamDatagramCertificateRequest& from)
      : CMsgSteamDatagramCertificateRequest(nullptr, from) {}
...
inline void CMsgSteamDatagramCertificate::set_allocated_legacy_identity_binary(::CMsgSteamNetworkingIdentityLegacyBinary* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::CMsgSteamNetworkingIdentityLegacyBinary*>(value)->GetArena();
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& CMsgSteamDatagramCertificate::_internal_gameserver_datacenter_ids()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& CMsgSteamDatagramCertificate::_internal_app_ids()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline void CMsgSteamDatagramCertificateRequest::set_allocated_cert(::CMsgSteamDatagramCertificate* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::CMsgSteamDatagramCertificate*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
